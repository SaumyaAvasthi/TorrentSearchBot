    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("Developer: @IshanAvasthi", url="https://t.me/IshanUpdates")]
            ]
        )
    )
            ...
            for torrent in torrentList:
                ...
                answers.append(
                    InlineQueryResultArticle(
                        ...
                        input_message_content=InputTextMessageContent(
                            message_text=f"\n\n**Name:** {torrent.title}\n**Size:** {torrent.filesize}\n**Seeders:** {torrent.seeds}\n**Leechers:** {torrent.leeches}\n\n`{torrent.magnetlink}`\n\nPowered By @DragonTorrentBot Join @IshanUpdates",
                            parse_mode="Markdown"
                        ),
                        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Search Again", switch_inline_query_current_chat="!pts ")]])
                    )
